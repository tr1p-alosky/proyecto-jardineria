...
export default function DashboardEmpleadoScreen() {
  ...
  const gridItems = [
    ...
    { label: 'Nómina', Icon: NominaIcon, screen: 'NominaEmpleadoScreen' as keyof RootStackParamList },
...
const styles = StyleSheet.create({
  ...
  userInfoEmail: { fontSize: 13, fontFamily: 'FunnelDisplay_400Regular', color: '#999' },
